...
//    }
//    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"GHSafe" withExtension:@"momd"];
...
//    }
//    
//    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"GHSafe.sqlite"];
//    
//    NSError *error = nil;
